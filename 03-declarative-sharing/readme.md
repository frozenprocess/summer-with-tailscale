...
Tailnets are isolated by design, but often we need to share resources across tailnets. Cross-tailnet sharing isn't new—in fact, you can achieve it today [without Declarative Tailnet Sharing](https://tailscale.com/docs/features/sharing). 
...
After you've created your external tailnet object in the policy file you can use its object name to enforce a behaviour.
